...
public class ProductDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String sql =
                ...
                "p.pickup_point_id, pp.point_name AS pickup_point_name " +
                "FROM products p " +
        ...
        try (
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    ...
                    // 设置自提点信息
                    long ppId = rs.getLong("pickup_point_id");
                    if (!rs.wasNull()) {
                        p.setPickupPointId(ppId);
                        p.setPickupPointName(rs.getString("pickup_point_name"));
                    }
